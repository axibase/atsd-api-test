...
public class PropertyCommandTest extends PropertyMethod {
    /* #2412 */
    @Test
    public void testMaxLength() throws ParseException, Exception, InterruptedException, JSONException {
    ...
    /* #2412 */
    @Test
    public void testMaxLengthOverflow() throws ParseException, Exception, InterruptedException, JSONException {
        final int MAX_LENGTH = 128 * 1024;
